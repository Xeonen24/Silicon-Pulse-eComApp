    ...
    <div className="about-page">
      <div className="about-content">
        ...
        <p className="para">
          ...
          computer parts and components. Our mission is to provide cutting-edge
          technology to enthusiasts, professionals, and gamers alike.
        </p>
        <p className="para">
        ...
        <p className="para">
          At Silicon Pulse, we believe in fostering a tech-savvy community. Join
          us in embracing the pulse of technology!
        </p>
      </div>
